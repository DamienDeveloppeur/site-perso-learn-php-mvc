<div id="header">
    <div id="logo">
    <a href="http://localhost/sitePerso2/VUE/index.php#accueil"> <img src="./public/images/Logo_OpenClassrooms.png"> </a>
    </div>
    <nav>
        <div id="accueilnav">
        <a href="http://localhost/sitePersoMVC/index.php" class="nonelink" >Accueil </a>
        </div>
        <div id="lien1">
